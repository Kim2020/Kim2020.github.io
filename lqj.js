(function(ext) {
    ...
    function getStatus(callback) {
        ...
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/106ada30-73e3-11ea-8411-e561fc3bf68fdc8a18a1-1a53-4eae-89b3-424fef2b9d78/status',
            dataType : 'jsonp',
            headers : {
    ...
    function classifyImage(imagedata, cacheKey, lastmodified, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/106ada30-73e3-11ea-8411-e561fc3bf68fdc8a18a1-1a53-4eae-89b3-424fef2b9d78/classify',
            dataType : 'json',
            type : 'POST',
    ...
    function storeImage(imagedata, label, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/106ada30-73e3-11ea-8411-e561fc3bf68fdc8a18a1-1a53-4eae-89b3-424fef2b9d78/train',
            dataType : 'json',
            method : 'POST',
            contentType : 'application/json',
            headers : {
