...
(function(ext) {
  ...
  var blocks = [
    [' ', '设置针脚 %d.digitalOutputs %m.outputs', 'digitalWrite', 13, 'on'],
    [' ', '设置类比 %d.analogOutputs to %n%', 'analogWrite', 9, 100],
    ['h', '当针脚 %d.digitalInputs 为 %m.outputs', 'whenDigitalRead', 9, 'on'],
    ['b', '针脚 %d.digitalInputs 为on?', 'digitalRead', 9],
    ['-'],
    ['h', '当类比 %d.analogInputs %m.ops %n%', 'whenAnalogRead', 'A0', '>', 50],
    ['r', '读取类比 %d.analogInputs', 'analogRead', 'A0'],
    ['-'],
    ['h', '当设备震动', 'whenIMUEvent'],
