(function(ext) {
    ...
    function getStatus(callback) {
        ...
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/fd3b08c0-69d0-11ea-917e-073da9e14d4f21554aaa-7e0f-4579-a976-a94bd1583b24/status',
            dataType : 'jsonp',
            headers : {
    ...
    function classifyImage(imagedata, cacheKey, lastmodified, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/fd3b08c0-69d0-11ea-917e-073da9e14d4f21554aaa-7e0f-4579-a976-a94bd1583b24/classify',
            dataType : 'json',
            type : 'POST',
    ...
    function storeImage(imagedata, label, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/fd3b08c0-69d0-11ea-917e-073da9e14d4f21554aaa-7e0f-4579-a976-a94bd1583b24/train',
            dataType : 'json',
            method : 'POST',
            contentType : 'application/json',
            headers : {
    ...
    var descriptor = {
        blocks : [
            ...
            [ 'r', '其它垃圾', 'return_label_0'],
            [ 'r', '厨余垃圾', 'return_label_1'],
            [ 'r', '可回收物', 'return_label_2'],
            [ 'r', '有害垃圾', 'return_label_3'],
            [ 'w', '添加训练样本 %s 到 %s', 'image_store', '图像', '标签']
        ],
        menus : {
            labels : [  'qtlj',  'cylj',  'khsw',  'yhlj',  ]
        }
    };

    // Register the extension
    ScratchExtensions.register('垃圾分类卡片', descriptor, ext);
