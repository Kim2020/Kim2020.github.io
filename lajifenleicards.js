(function(ext) {
    ...
    function getStatus(callback) {
        ...
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/6c8f8300-2a56-11ea-a46a-49ce338337a8986b1505-d8f6-457b-b340-0deb00709e09/status',
            dataType : 'jsonp',
            headers : {
    ...
    function classifyImage(imagedata, cacheKey, lastmodified, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/6c8f8300-2a56-11ea-a46a-49ce338337a8986b1505-d8f6-457b-b340-0deb00709e09/classify',
            dataType : 'json',
            type : 'POST',
    ...
    function storeImage(imagedata, label, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/6c8f8300-2a56-11ea-a46a-49ce338337a8986b1505-d8f6-457b-b340-0deb00709e09/train',
            dataType : 'json',
            method : 'POST',
            contentType : 'application/json',
            headers : {
