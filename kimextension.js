(function(ext) {
    ...
    var descriptor = {
        blocks : [
            [ 'R', '识别 %s (标签)', 'image_classification_label', '图像' ],
            [ 'R', '识别 %s (可能性)', 'image_classification_confidence', '图像' ],
            [ 'r', '可回收物', 'return_label_0'],
            [ 'r', '其他垃圾', 'return_label_1'],
            [ 'r', '有害垃圾', 'return_label_2'],
            [ 'r', '厨余垃圾', 'return_label_3'],
            [ 'w', '添加训练样本 %s 到 %m.labels', 'image_store', '图像', '可回收物'],
            [ 'w', '添加训练样本 %s 到 %s', 'image_store', '图像', '标签']
        ],
        menus : {
            labels : [  '可回收物',  '其他垃圾',  '有害垃圾',  '厨余垃圾',  ]
        }
    };
